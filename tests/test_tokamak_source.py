...
def test_creation(tokamak_source_example):
    ...
    for source in tokamak_source_example.sources:
        assert isinstance(source, IndependentSource)
...
def test_major_radius(tokamak_args_dict, minor_radius, major_radius):
    """Checks that TokamakSource creation accepts valid major radius"""
    ...
    assert tokamak_source.major_radius == major_radius
...
def test_bad_major_radius(tokamak_args_dict, minor_radius, major_radius):
    """Checks that TokamakSource creation rejects invalid major radius"""
    tokamak_args_dict["minor_radius"] = minor_radius
    tokamak_args_dict["major_radius"] = major_radius
...
def test_minor_radius(tokamak_args_dict, major_radius, minor_radius):
    """Checks that TokamakSource creation accepts valid minor radius"""
    tokamak_args_dict["major_radius"] = major_radius
    tokamak_args_dict["minor_radius"] = minor_radius
    ...
    tokamak_source = TokamakSource(**tokamak_args_dict)
    assert tokamak_source.minor_radius == minor_radius
...
def test_bad_minor_radius(tokamak_args_dict, major_radius, minor_radius):
    """Checks that TokamakSource creation rejects invalid minor radius"""
    tokamak_args_dict["major_radius"] = major_radius
    tokamak_args_dict["minor_radius"] = minor_radius
    with pytest.raises(ValueError):
        tokamak_source = TokamakSource(**tokamak_args_dict)
...
def test_elongation(tokamak_args_dict, elongation):
    """Checks that TokamakSource creation accepts valid elongation"""
    tokamak_args_dict["elongation"] = elongation
    tokamak_source = TokamakSource(**tokamak_args_dict)
    assert tokamak_source.elongation == elongation


@pytest.mark.parametrize("elongation", [0, -5, "hello world"])
def test_bad_elongation(tokamak_args_dict, elongation):
    """Checks that TokamakSource creation rejects invalid elongation"""
    tokamak_args_dict["elongation"] = elongation
    with pytest.raises(ValueError):
        tokamak_source = TokamakSource(**tokamak_args_dict)
...
def test_triangularity(tokamak_args_dict, triangularity):
    """Checks that TokamakSource creation accepts valid triangularity"""
    tokamak_args_dict["triangularity"] = triangularity
    tokamak_source = TokamakSource(**tokamak_args_dict)
    assert tokamak_source.triangularity == triangularity
...
def test_bad_triangularity(tokamak_args_dict, triangularity):
    """Checks that TokamakSource creation rejects invalid triangularity"""
    tokamak_args_dict["triangularity"] = triangularity
    with pytest.raises(ValueError):
        tokamak_source = TokamakSource(**tokamak_args_dict)
...
def test_shafranov_factor(tokamak_args_dict, major_radius, minor_radius, shaf):
    """Checks that TokamakSource creation accepts valid Shafranov factor"""
    tokamak_args_dict["major_radius"] = major_radius
    tokamak_args_dict["minor_radius"] = minor_radius
    tokamak_args_dict["pedestal_radius"] = 0.8 * minor_radius
    tokamak_args_dict["shafranov_factor"] = shaf
    tokamak_source = TokamakSource(**tokamak_args_dict)
    assert tokamak_source.shafranov_factor == shaf
...
def test_bad_shafranov_factor(tokamak_args_dict, major_radius, minor_radius, shaf):
    """Checks that TokamakSource creation rejects invalid Shafranov factor"""
    tokamak_args_dict["major_radius"] = major_radius
    tokamak_args_dict["minor_radius"] = minor_radius
    tokamak_args_dict["pedestal_radius"] = 0.8 * minor_radius
    tokamak_args_dict["shafranov_factor"] = shaf
